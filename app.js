...
const getPurchasePricesByPage = async (page) => {
  ...
  const {data} = await axios({
    method: 'GET',
    url: `https://www.rightmove.co.uk/property-for-sale/find.html?minBedrooms=3&maxBedrooms=3&keywords=&sortType=2&viewType=LIST&channel=BUY&index=${index}&radius=0.0&locationIdentifier=USERDEFINEDAREA%5E%7B%22id%22%3A%226850088%22%7D`
  })
